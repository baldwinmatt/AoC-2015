...
namespace aoc {
    ...
    struct point {
        ...
        static constexpr inline point up_and_right() noexcept {
            return up() + right();
        }

        static constexpr inline point up_and_left() noexcept {
            return up() + left();
        }

        static constexpr inline point down_and_right() noexcept {
            return down() + right();
        }

        static constexpr inline point down_and_left() noexcept {
            return down() + left();
        }
    ...
    const static std::vector<point> point_directions_8 = {
        point::right(),
        point::up(),
        point::left(),
        point::down(),
